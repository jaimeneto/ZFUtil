 ...
 */
class ZFUtil_View_Helper_Calendar extends Zend_View_Helper_Abstract
{
    protected $date;
    protected $now;
    ...
    public function render()
    {
        ...
        for($i=0; $i<6; $i++) {
            ...
            for($j=0; $j<=6; $j++) {
                ...
                if (!$this->ignoreSelectedDate 
                        && $tmpDate->compareDate($this->date) == 0) {
                ...
                $xhtml .= '<td '
                        ...
                        . $tmpDate->get('yyyy-MM-dd')
                        .'">'
                        . ($this->getInsertsPosition() == self::INSERT_PREPEND 
                            ? $htmlInserts : '')
                        . $day
                        . ($this->getInsertsPosition() == self::INSERT_APPEND 
                            ? $htmlInserts : '')
                        . '</a>'
                        . ($this->getInsertsPosition() == 
